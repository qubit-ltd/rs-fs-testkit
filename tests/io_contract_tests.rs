...
#[test]
#[should_panic(
    expected = "recursive list must return the nested matching child"
)]
...
#[test]
#[should_panic(
    expected = "required atomic rename must report atomic publication"
)]
...
#[test]
#[should_panic(
    expected = "copy must reject an existing destination by default"
)]
